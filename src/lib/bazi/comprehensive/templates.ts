...
// _pick() selects a variant at generation time.
// =============================================================================

export function _pick(variants: string[]): string {
...
export const DM_NATURE: Record<string, {
  name: string;
  chinese: string;
  nature: string[];
  personality: string;
...
export const STRENGTH_VERDICTS: Record<string, string[]> = {
  extremely_strong: [
...
export const TEN_GOD_INTERPRETATIONS: Record<string, Record<string, string[]>> = {
  F: {
    PROMINENT: [
...
export const SHEN_SHA_IMPACTS: Record<string, Record<string, string[]>> = {
  "天乙贵人": {
    present: [
...
export const INTERACTION_IMPACTS: Record<string, Record<string, string[]>> = {
  clash: {
    "year-month": [
...
export const SEVERITY_LANGUAGE: Record<string, string[]> = {
  mild: [
...
export const HEALTH_ELEMENT_MAP: Record<string, {
  yin_organ: string;
  yang_organ: string;
  body_parts: string;
  excess: string;
...
export const ELEMENT_REMEDIES: Record<string, {
  colors: string[];
  avoid_colors: string[];
  industries: string[];
  environment: string[];
...
export const LIFE_LESSON_TEMPLATES: Record<string, string[]> = {
  weak_water: [
...
export const STRENGTH_EXPLANATION: Record<string, string> = {
  weak:
...
export const HEALTH_BEHAVIORAL_REMEDIES: Record<string, string> = {
...
export const CONTROL_CYCLE_EXPLANATIONS: Record<string, string> = {
